function [out]=RQA2_FAST_lengthVar(x, y, lenNum, d_p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FUNCTION
...
upTri = triu(padarray(rqa_matrix, [lenNum, lenNum]), 1); 
...
count_diagonal = zeros(1, lenNum); 
for i = 1:lenNum
    temp1 = circshift(upTri, -i); 
    temp1 = circshift(temp1, -i, 2); 
    count_diagonal(i) = sum(sum(upTri.*temp1)); 
end
...
%     end
% end
count_vertical = zeros(1, lenNum); 
for i = 1:lenNum
    temp1 = circshift(upTri, -i); 
    count_vertical(i) = sum(sum(upTri.*temp1)); 
end
...
count_horizontal = zeros(1, lenNum); 
for i = 1:lenNum
    temp1 = circshift(upTri, -i, 2); 
...
%     end
% end
retracing = zeros(1, lenNum); 
for i = 1:lenNum
    temp1 = circshift(upTri, i); 
    temp1 = circshift(temp1, -i, 2); 
    retracing(i) = sum(sum(upTri.*temp1)); 
end
